...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../data/asset", "../data/tag", "assert", "lodash", "../data", "pg"], factory);
    }
    ...
    before('Loading models...', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Data.Initialize()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    var Query = function (str, args) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, DataPool.connect()];
            case 1: return [4 /*yield*/, (_a.sent()).query(str, args)];
    ...
    describe('Validators', function () {
        ...
        describe('Objects', function () {
            it('Fails with extra, unaccepted keys', function () {
                var obj = new asset_1["default"](-1, 'asset', 'a description', 33.44);
                obj.DangerTag = 3;
                assert.throws(function () { return Data.ValidateObject(obj, new asset_1["default"]()); }, /^Error: Object does not align with schema.$/, 'This should break! SQL injection as an object key variable is dangerous');
            });
            it('Passes with expected object', function () {
                var obj = new asset_1["default"](-1, 'asset', 'descriptin', 33.44);
                Data.ValidateObject(obj, new asset_1["default"]());
            });
        });
    });
    /**
    ...
    describe('Accessors', function () {
        ...
        after(function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, Query("DELETE FROM tag WHERE name like 'tag_%'")];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        ...
        describe('Delete', function () {
            var asset = new asset_1["default"](-1, 'an asset name', 44.44);
            beforeEach(function () {
                return __awaiter(this, void 0, void 0, function () {
                    var res, inserted;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, Query("SELECT * FROM asset WHERE name='an asset name'")];
                            case 1:
                                res = (_a.sent()).rows;
                                if (!(res.length == 1)) return [3 /*break*/, 2];
                                asset.id = res[0].id;
                                return [2 /*return*/];
                            case 2: return [4 /*yield*/, Query("INSERT INTO asset (name, description, purchase_value) VALUES ('an asset name', 'an asset description', 44.44) RETURNING id")];
                            case 3:
            ...
            it('Errors when id is -1', function (done) {
                Data.Delete(new asset_1["default"](-1, 'no name', 'description here', 44.44))["catch"](function (err) {
        ...
        describe('List/Page', function () {
            ...
            it('Pages descending properly', function (done) {
                Data.List(tag_1["default"], 50, false)
                    .then(function (res) {
                    var firstTag = _.toNumber(res[0].name.split('_')[1]);
                    var secondTag = _.toNumber(res[49].name.split('_')[1]);
            ...
            it('Reverses ascend/descend if pages are negative', function (done) {
                Data.Page(tag_1["default"], 50, -1, false)
                    .then(function (res) {
                    var firstTag = _.toNumber(res[0].name.split('_')[1]);
                    var secondTag = _.toNumber(res[49].name.split(_)[1]);
            ...
            it('Errors on invalid page/amt/class', function (done) {
                Data.Page(tag_1["default"], 'blue', 'green')
                    .then(function (res) {
        ...
        describe('Save', function () {
            it('Returns a row', function (done) {
                Data.Save(new asset_1["default"](-1, 'from_code_asset_row', 'The first asset generated from code', 54.45))
                    .then(function (res) {
            ...
            it('Sets the id of an object', function (done) {
                var obj = new asset_1["default"](-1, 'from_code_asset_id', 'The first asset generated from code again', 343.33);
                Data.Save(obj)
                    .then(function () {
            ...
            it('Refuses to save missing required fields', function (done) {
                var obj = new asset_1["default"](-1, undefined, 'a desc', undefined);
                Data.Save(obj)
                    .then(function () {
        ...
        describe('Update', function () {
            ...
            before('Creating original asset', function (done) {
                testAsset = new asset_1["default"](-1, 'test_asset_update', 'a description', 44.44);
                DataPool.connect()
                    .then(function (client) {
            ...
            it('Async Puts new data in database', function () {
                return __awaiter(this, void 0, void 0, function () {
                    var res, description;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, Data.Update(testAsset)];
                            case 1:
                                res = (_a.sent()).description;
                                return [4 /*yield*/, Query("SELECT description FROM asset WHERE name='test_asset_update'")];
                            case 2:
                                description = (_a.sent()).rows[0].description;
            ...
            it('Errors on invalid id', function (done) {
                var fail = new asset_1["default"](-1, 'A fake one', 'fake description', 1337.13);
                Data.Update(fail)
                    .then(function (res) {
                    console.log(res);
                })["catch"](function (err) {
            ...
            it('searches partials', function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                SearchObj = new tag_1["default"](undefined, 'tag_2');
                                return [4 /*yield*/, tag_1["default"].Search(SearchObj, 50, 0)
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.trys.push([1, 3, , 4]);
                                return [4 /*yield*/, Data.Search(SearchObj)];
                            case 2:
                                _a.sent();
            ...
            it('returns 1 result if valid id is provided', function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0: return [4 /*yield*/, Query("SELECT * FROM tag WHERE name='tag_233' LIMIT 1")];
                            case 1:
                                obj = (_c.sent()).rows[0];
                                obj.tablename = 'tag';
                                _b = (_a = assert).ok;
                                return [4 /*yield*/, Data.Search(obj)];
                            case 2:
    ...
    describe('Converter', function () {
        describe('#ObjectToQueryable()', function () {
            ...
            it('Formats object to expected', function () {
                var obj = new asset_1["default"](-1, 'asset_test_1', 'An asset that is used for testing', '33.44', undefined);
