...
describe('#TaskboardController', function () {
    ...
    describe('DeleteTasklist', function () {
        ...
        it('Refuses if the user is not part of the board');
        it('Refuses if the tasklist does not exist');
        it('Refuses if the user does not exist');
    ...
    describe('MoveTaskList', function () {
        ...
        it('Refuses if the user does not exist');
        it('Refuses if the new board does not exist');
    ...
    describe('SetTaskStatus', function () {
        ...
        it('Refuses if the user does not exist');
        it('Refuses if the task does not exist');
    ...
    describe('DeleteTask', function () {
        ...
        it('Refuses if task does not exist');
        it('Deletes the task');
    });
